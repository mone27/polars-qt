...
impl UnitRegistry {
    fn new_with_definitions() -> Self {
        ...
        registry.add_reduced_electric_field();
    ...
    fn add_area(&mut self) {
        self.add_dimension("area", self.try_get_dimension("length").pow(2));
    ...
    fn add_frequency(&mut self) {
        self.add_dimension("frequency", self.try_get_dimension("time").pow(-1));
    ...
    fn add_wavenumber(&mut self) {
        self.add_dimension("wavenumber", self.try_get_dimension("length").pow(-1));
    ...
    fn add_velocity(&mut self) {
        self.add_dimension(
            "velocity",
            self.try_get_dimension("length") / self.try_get_dimension("time"),
        );
    ...
    fn add_volumetric_flow_rate(&mut self) {
        self.add_dimension(
            ...
            self.try_get_dimension("volume") / self.try_get_dimension("time"),
        );
    ...
    fn add_acceleration(&mut self) {
        self.add_dimension(
            "acceleration",
            self.try_get_dimension("velocity") / self.try_get_dimension("time"),
        );
        self.add_unit(self.try_get_unit("meter") / self.try_get_unit("second").pow(2));
        self.add_unit_deriv("galileo", "acceleration", 0.01, "meter/second^2"); // centimeter / second^2
    }

    fn add_force(&mut self) {
        self.add_dimension(
            "force",
            self.try_get_dimension("mass") * self.try_get_dimension("acceleration"),
        );
    ...
    fn add_energy(&mut self) {
        self.add_dimension(
            "energy",
            self.try_get_dimension("force") * self.try_get_dimension("length"),
        );
        ...
        self.add_unit_deriv("thermochemical_british_thermal_unit", "energy", 1054.35026444, "joule"); // Btu_th
    ...
    fn add_power(&mut self) {
        self.add_dimension(
            "power",
            self.try_get_dimension("energy") / self.try_get_dimension("time"),
        );
    ...
    fn add_density(&mut self) {
        self.add_dimension(
            "density",
            self.try_get_dimension("mass") / self.try_get_dimension("volume"),
        );
    ...
    fn add_pressure(&mut self) {
        self.add_dimension(
            "pressure",
            self.try_get_dimension("force") / self.try_get_dimension("area"),
        );
    ...
    fn add_viscosity(&mut self) {
        self.add_dimension(
            "viscosity",
            self.try_get_dimension("pressure") * self.try_get_dimension("time"),
        );
    ...
    fn add_kinematic_viscosity(&mut self) {
        self.add_dimension(
            "kinematic_viscosity",
            self.try_get_dimension("area") / self.try_get_dimension("time"),
        );
    ...
    fn add_fluidity(&mut self) {
        self.add_dimension("fluidity", self.try_get_dimension("viscosity").pow(-1));
    ...
    fn add_amount_of_substance(&mut self) {
        self.add_dimension("substance", self.try_get_dimension("dimensionless"));
        self.add_unit(self.try_get_unit("mole"));
    ...
    fn add_concentration(&mut self) {
        self.add_dimension(
            "concentration",
            self.try_get_dimension("substance") / self.try_get_dimension("volume"),
        );
    ...
    fn add_catalytic_activity(&mut self) {
        self.add_dimension(
            "activity",
            self.try_get_dimension("substance") / self.try_get_dimension("time"),
        );
    ...
    fn add_entropy(&mut self) {
        self.add_dimension(
            "entropy",
            self.try_get_dimension("energy") / self.try_get_dimension("temperature"),
        );
    ...
    fn add_molar_entropy(&mut self) {
        self.add_dimension(
            "molar_entropy",
            self.try_get_dimension("entropy") / self.try_get_dimension("substance"),
        );
    ...
    fn add_charge(&mut self) {
        self.add_dimension(
            "charge",
            self.try_get_dimension("current") * self.try_get_dimension("time"),
        );
    ...
    fn add_radiation(&mut self) {
        self.add_dimension("radiation", self.try_get_dimension("time").pow(-1));
        ...
        self.add_unit_deriv("gray", "radiation", 1.0, "joule/kilogram");
        self.add_unit_deriv("sievert", "radiation", 1.0, "joule/kilogram");
        self.add_unit_deriv("rads", "radiation", 0.01, "gray");
        self.add_unit_deriv("rem", "radiation", 0.01, "sievert");
    ...
    fn add_heat_transmission(&mut self) {
        self.add_dimension(
            "heat_transmission",
            self.try_get_dimension("energy") / self.try_get_dimension("area"),
        );
    ...
    fn add_luminance(&mut self) {
        self.add_dimension(
            "luminance",
            self.try_get_dimension("luminosity") / self.try_get_dimension("area"),
        );
    ...
    fn add_luminous_flux(&mut self) {
        self.add_dimension("luminous_flux", self.try_get_dimension("luminosity"));
    ...
    fn add_illuminance(&mut self) {
        self.add_dimension(
            "illuminance",
            self.try_get_dimension("luminous_flux") / self.try_get_dimension("area"),
        );
    ...
    fn add_intensity(&mut self) {
        self.add_dimension(
            "intensity",
            self.try_get_dimension("power") / self.try_get_dimension("area"),
        );
    ...
    fn add_current(&mut self) {
        self.add_dimension("current", self.try_get_dimension("dimensionless"));
        self.add_unit(self.try_get_unit("ampere"));
        ...
        self.add_unit_deriv("planck_current", "current", 3.4789e25, "ampere"); // (c^6 / gravitational_constant / k_C)^0.5
    }

    fn add_electric_potential(&mut self) {
        self.add_dimension(
            "electric_potential",
            self.try_get_dimension("energy") / self.try_get_dimension("charge"),
        );
        ...
        self.add_unit_deriv("conventional_volt_90", "electric_potential", 1.0000000000000002, "volt");
        // K_J90 / K_J
    }
    ...
    fn add_resistivity(&mut self) {
        self.add_dimension(
            "resistivity",
            self.try_get_dimension("resistance") * self.try_get_dimension("length"),
        );
    ...
    fn add_inductance(&mut self) {
        self.add_dimension(
            "inductance",
            self.try_get_dimension("magnetic_flux") / self.try_get_dimension("current"),
        );
    ...
    fn add_magnetomotive_force(&mut self) {
        self.add_dimension("magnetomotive_force", self.try_get_dimension("current"));
    ...
    fn add_electric_dipole_moment(&mut self) {
        self.add_dimension(
            "electric_dipole",
            self.try_get_dimension("charge") * self.try_get_dimension("length"),
        );
    ...
    fn add_magnetic_dipole_moment(&mut self) {
        self.add_dimension(
            "magnetic_dipole",
            self.try_get_dimension("current") * self.try_get_dimension("area"),
        );
        ...
        self.add_unit_deriv("nuclear_magneton", "magnetic_dipole", 5.050783699e-27, "ampere*meter^2");
        // e * hbar / (2 * m_p)
    }

    fn add_refractive_index(&mut self) {
        self.add_dimension("refractive_index", self.try_get_dimension("dimensionless"));
